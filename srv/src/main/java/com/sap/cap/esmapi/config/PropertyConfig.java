...
@Configuration
@PropertySources(
{ @PropertySource("classpath:messages.properties"), @PropertySource("classpath:srvcloudurls-dev.properties"),
		@PropertySource("classpath:srvcloudurls-test.properties"), @PropertySource("classpath:srvcloudurls.properties"),
...
public class PropertyConfig
{
	...
	public TY_SrvCloudUrls SrvCloudUrlsT(@Value("${username}") final String userName,
			@Value("${password}") final String password, @Value("${casesurl}") final String casesUrl,
			@Value("${cpurl}") final String cpUrl, @Value("${accountsurl}") final String acUrl,
			@Value("${notesurl}") final String notesUrl, @Value("${topN}") final String topN,
			@Value("${caseTemplateUrl}") final String caseTemplateUrl,
