...
public class AppSecurityConfig
{
  ...
  // public SecurityFilterChain appFilterChainforTest(HttpSecurity http) throws
  // Exception
  // {
  ...
  // "/static/css/**").permitAll().antMatchers("/web-components.js/**")
  // .permitAll().antMatchers(HttpMethod.GET,
  // "/static/js/**").permitAll().antMatchers("/ess/**").authenticated() // Only
  // .antMatchers("/lso/**").hasAnyAuthority(GC_Constants.gc_role_employee_lso,
  // GC_Constants.gc_role_contractor_lso)
